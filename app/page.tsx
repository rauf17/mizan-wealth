    ...
    <div className="relative min-h-screen overflow-hidden flex flex-col justify-between">
      ...
      <header className="border-b border-border/40 backdrop-blur-md sticky top-0 z-50 bg-background/80">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-primary flex items-center justify-center font-heading font-bold text-white shadow-lg">
              M
            </div>
            <span className="font-heading font-bold text-lg tracking-wider text-primary">
              MIZAN WEALTH
            </span>
          </div>
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/dashboard"
              className="text-xs font-bold px-4 py-2 rounded-xl bg-primary text-white hover:bg-primary/95 transition-all shadow-md shadow-primary/10"
            >
              Enter Dashboard
            </Link>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-20 flex-1 flex flex-col items-center justify-center text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-heading font-extrabold tracking-tight max-w-4xl leading-tight mb-6">
          ...
          <span className="text-brand-gradient">Islamic Principles</span>
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-6xl text-left">
          ...
          <Link
            href="/dashboard"
            className="group relative p-6 rounded-2xl bg-white border border-border/80 hover:border-primary/30 transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-1"
          >
            <div className="w-12 h-12 rounded-xl bg-primary/5 flex items-center justify-center text-primary mb-5 group-hover:scale-110 transition-transform">
              <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
              </svg>
            </div>
            <h3 className="font-heading font-bold text-lg text-primary mb-2">Zakat Calculator</h3>
          ...
          >
            ...
            <h3 className="font-heading font-bold text-lg text-primary mb-2">Purity Screener</h3>
            <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          >
            ...
            <h3 className="font-heading font-bold text-lg text-primary mb-2">Growth Projection</h3>
            <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          >
            ...
            <h3 className="font-heading font-bold text-lg text-primary mb-2">Inheritance Modeler</h3>
            <p className="text-muted-foreground text-sm leading-relaxed">
