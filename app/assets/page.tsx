    ...
    <div className="min-h-screen bg-background text-foreground p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        <header className="flex justify-between items-center border-b border-border/40 pb-6">
          <div>
            <h1 className="text-3xl font-heading font-bold text-white">Asset Inventory</h1>
            <p className="text-muted-foreground text-sm">Add and manage your liquid, gold, silver, real estate, and stock holdings</p>
          </div>
          <Link
            href="/"
        ...
        <main className="p-6 rounded-2xl bg-card border border-border/50">
          <p className="text-muted-foreground text-sm">Asset management ledger stub page.</p>
        </main>
      </div>
    </div>
  );
